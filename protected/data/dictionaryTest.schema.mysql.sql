...
CREATE TABLE IF NOT EXISTS yii_dictionaryTest.entry(
  id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  name VARCHAR(100) NOT NULL,
  date_entered TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  date_updated DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS yii_dictionaryTest.user(
  id INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS yii_dictionaryTest.type(
  id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  name VARCHAR(100) NOT NULL,
  symbol VARCHAR(5),
  date_entered TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS yii_dictionaryTest.definition(
  id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT fk_definition_dictionary
    ...
    REFERENCES yii_dictionaryTest.dictionary (id)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT fk_definition_entry
    FOREIGN KEY (entry_id)
    REFERENCES yii_dictionaryTest.entry (id)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
