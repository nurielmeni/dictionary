 ...
 */
class Type extends DictionaryCActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
            ...
            array('symbol', 'filter', 'filter' => 'trim'),
            array('symbol', 'filter', 'filter' => 'strip_tags'),
			array('by_user_id', 'numerical', 'integerOnly' => true),
			array('date_updated, date_entered', 'date', 'format' => 'DD-MM-yyyy'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, symbol, date_entered, date_updated, by_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'definitions' => array(self::HAS_MANY, 'Definition', 'type_id'),
		);
	}
